...
public class LexicalAnalyzer {
    ...
    private void recordToken(String type) {
            ...
            case "operator":
                switch (value) {
                    ...
                    case "<=":
                        ...
                        break;
                    case "==":
                        tokenType = TokenType.DOUBLE_EQUAL;
                        break;
                    case "!=":
            ...
            case "delimiter":
                switch (value) {
                    ...
                    case ")":
                        ...
                        break;
                    case "{":
                        tokenType = TokenType.L_CURLY_BRACE;
                        break;
                    case "}":
                        tokenType = TokenType.R_CURLY_BRACE;
                        break;
                    case ";":
        ...
        if (tokenType != null) {
            Token currentToken = TokenFactory.getToken(tokenType);
    ...
    private void recordToken(String error, int lineNum) {
        Token currentToken = TokenFactory.getToken(TokenType.UNRECOGNIZED);
        currentToken.setError(error);
        currentToken.setLineNum(lineNum);
        currentToken.setValue(token.toString());
        tokenList.add(currentToken);
        token = new StringBuilder();
    }
    ...
    public void exportLexicalAnalyzeResult() {
